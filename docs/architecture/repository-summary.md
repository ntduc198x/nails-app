...
nails-app/
  ...
  supabase/               # bootstrap SQL, grouped patches, migrations, seeds
...
- `supabase/README.md` là chỉ mục nhanh cho nhóm `patches/`, `migrations/`, `seeds/`, và `functions/`.
...
- `supabase/patches/customer/customer_mobile_schema_2026_04.sql` - Customer mobile schema
