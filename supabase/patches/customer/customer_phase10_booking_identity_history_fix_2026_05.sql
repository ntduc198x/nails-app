-- Phase 10: keep customer app booking history aligned with customer_accounts identity.
-- - Signed-in app users should book against their linked customer_id.
-- - Booking phone should backfill linked customer.phone only when it is blank.
