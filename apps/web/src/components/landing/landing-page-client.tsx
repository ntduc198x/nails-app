...
export function LandingPageClient({ initialExplore, initialHomeFeed }: LandingPageClientProps) {
  ...
  const serviceMobileSlides = useMemo(() => chunkItemsLoopFilled(featuredServices, 2), [featuredServices]);
  ...
  const storyMobileSlides = useMemo(() => chunkItemsLoopFilled(stories, 2), [stories]);
  const productMobileSlides = useMemo(() => chunkItemsLoopFilled(products, 2), [products]);
  const testimonialMobileSlides = useMemo(() => chunkItemsLoopFilled(testimonials, 2), [testimonials]);
