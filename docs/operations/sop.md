...
```bash
# Run patch
psql -h <host> -U postgres -d nails_app -f supabase/patches/auth/auth_runtime_patch_2026_05_user_roles_conflict.sql
```
...
```bash
# Run patch
psql -h <host> -U postgres -d nails_app -f supabase/patches/customer/customer_mobile_runtime_patch_2026_05.sql
```
